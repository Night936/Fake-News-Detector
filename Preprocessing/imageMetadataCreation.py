...
def buildSplit(tsv_path, split_name, image_root):
    ...
    for _, row in df.iterrows():
        ...
        records.append({
            "source_id": fakeddit_id,   # NOTE: string here -- see README for why
...
def main():
    ...
    for split_name, tsv_path, out_name in [
        ...
        records = buildSplit(tsv_path, split_name, config.MINI_IMAGES)
