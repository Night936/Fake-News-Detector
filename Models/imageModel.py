...
class ImageExpertsModel(nn.Module):
    def __init__(self, cfg):
        ...
        # 4. Gating / Mask Attention Mechanism
        ...
        layers.append(nn.Linear(in_dim, 2))  # 2 output classes: Real (0) or Fake (1)
    ...
    def forward(self, img_spatial, img_frequency):
        ...
        # 3. Apply weights to the embeddings
